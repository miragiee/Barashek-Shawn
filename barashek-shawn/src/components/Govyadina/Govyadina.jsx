...
import styles from './Govyadina.module.css';
...
export default function Govyadina() {
    ...
    if (loading) {
        return <div className={styles.GovyadinaBlock}><h2>Загрузка...</h2></div>;
    }

    return (
        <div className={styles.GovyadinaBlock}>
            <h2>Говядина</h2>
